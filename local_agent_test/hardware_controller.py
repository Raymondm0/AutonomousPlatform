...
def do_experiment(reagent:str, spin_speed = 3000, spin_acc = 1000, spin_dur = 30, volume = 10) -> str:
    """
    ...
    :param spin_dur: spin duration for spin coating in s
    ...
    try:
        ...
        spin_dur = 1000 * spin_dur
        if local_client.is_connected:
            # char p is a start character
